 ...
 *
 * @author Original : plosson on 06-janv.-2006 15:05:44 - Last modified  by $Author: jamao $ on $Date: 2013/08/13 03:46:01 $
...
public class UploadListener implements OutputStreamListener
{
    ...
    private void updateUploadInfo(String status)
    {
        ...
        request.getSession().setAttribute(LFileUpFilter.UPLOAD_INFO, new ProgressInfo(totalFiles, totalToRead, totalBytesRead,delta,status));
    }
