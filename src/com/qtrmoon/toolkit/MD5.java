...
/**
 * MD5 11位 加密处理类，同时支持JDK 16、32位加密算法
 * 
...
public class MD5 {
	 ...
	 * @throws NoSuchAlgorithmException
	 */
	public String getMD5to32(String param) {
		try {
			return jdkmd5(param);
	...
	// 这是MD5这个类的标准构造函数，JavaBean要求有一个public的并且没有参数的构造函数&65533;&65533;
	private MD5() {
		md5Init();
		return;
	}
	...
	// Suite&1460;&65533;б&65533;&1532;&65533;&65533;Test
	// // Suite
	//  
