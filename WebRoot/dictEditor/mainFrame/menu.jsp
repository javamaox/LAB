...
<head>
	...
	function loadPage(){
		$(".imgs").click(function(){
			...
			parent.titleFrame.document.location="./title.jsp?funcid="+funcid;
		}).mouseover(function(){
			$(this).css("border","#eee 1px dotted");
			$(this).css("margin","0px");
		}).mouseout(function(){
			$(this).css("border","0px");
			$(this).css("margin","1px");
...
<body style="background:url(../imgs/menuBk.gif) top repeat-x;padding:10px;text-align:center;">
	<logic:notEmpty name="functionList">
		<logic:iterate id="row" name="functionList">
			<div style="padding:0px 10px;" id="${row.id}">
