...
<html>
	...
	<body>
		...
		<pageFmt:dictIncludeAjaxTree dictId="TEST_DQBM" style="checkbox" value="131026,131081"  expand="1" context="yes"/>
		</div>
		
		Ajax多选嵌入树
		<div style="height:200px">
		<pageFmt:dictIncludeAjaxTree dictId="TEST_DQBM_AJAX" style="checkbox" value="131002,131023"  expand="1" context="auto_no"/>
		</div>
		注意：context=[yes|no|auto_yes|auto_no]。yes、no会隐藏小锁，auto显示小锁并开合。
		<br/>
		<br>
