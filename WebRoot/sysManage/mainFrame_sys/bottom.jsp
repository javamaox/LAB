...
<BODY class="bottomPage">
	...
	<div style="line-height:28px;color:white;padding-left:100px;">
		<b>登录机构：${organName}</b> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<b>登录用户：${userName}</b> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<logic:equal value="icon" name="operMode">
			<a href="/${projectName}/sysManage/user.do?method=updUserInfo&from=perUpdPassword" target="_blank" style="color:white;">修改密码</a>
